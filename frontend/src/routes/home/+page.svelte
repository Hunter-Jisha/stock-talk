...
<MenuWrapper>
    <div class="overflow-hidden w-full h-full flex flex-row gap-2 md:p-4 bg-stone-100">
        <div class="overflow-hidden w-1/2 flex-shrink-0 h-full flex flex-col gap-2">
            ...
            <Form class="w-full h-12 px-4 relative">
                <input class="w-full h-full rounded-xl bg-white px-4 text-stone-700 text-lg" type="text" placeholder="Search" name="search">
            ...
            <div class="w-full flex flex-col">
                <div class="flex flex-row w-full justify-between items-center px-4">
                    ...
                    <button class="h-full text-stone-500 p-0.5">
        ...
        <div class="hidden md:flex w-full h-full flex-col">
